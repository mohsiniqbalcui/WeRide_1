...
public class singin_activity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (mAuth.getCurrentUser() != null) {
			startActivity(new Intent(singin_activity.this, MainActivity1.class));
			finish();
		}
						...
						.addOnCompleteListener(singin_activity.this, new OnCompleteListener<AuthResult>() {
							...
							public void onComplete(@NonNull Task<AuthResult> task) {
								...
								if (task.isSuccessful()) {
									...
									Intent intent = new Intent(singin_activity.this, MainActivity1.class);
		...
		mAuthListner = new FirebaseAuth.AuthStateListener() {
			...
			public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
				if (firebaseAuth.getCurrentUser() != null) {
					...
					navUsername.setText(googleName);
					navUsername.setText(googleEmail);
